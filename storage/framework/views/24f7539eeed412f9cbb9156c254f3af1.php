...
<?php $component = App\View\Components\AppLayout::resolve(['hideSidebar' => true,'topNav' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('globalDashboard', () => ({
                favorites: <?php echo json_encode($favoritesIds, 15, 512) ?>,
                ...
                async toggleFavorite(id, type) {
                    try {
                        const response = await fetch('<?php echo e(route('api.favorites.toggle')); ?>', {
                            method: 'POST',
                            headers: {
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="md:col-span-3 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex flex-wrap gap-8">
                        ...
                        <a href="<?php echo e($fav->url); ?>" class="group flex flex-col items-center w-24">
                            <div class="relative w-16 h-16 mb-2 flex items-center justify-center bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-700 group-hover:border-purple-500 transition-all duration-200 shadow-sm overflow-hidden">
                                <?php if($fav->logo): ?>
                                    <img src="<?php echo e(asset('storage/' . $fav->logo)); ?>" alt="<?php echo e($fav->name); ?>" class="w-10 h-10 object-contain group-hover:scale-110 transition-transform">
                                <?php else: ?>
                                    <div class="w-full h-full flex items-center justify-center bg-purple-50 dark:bg-purple-900 border-none">
                                        <span class="text-xl font-bold text-purple-600 dark:text-purple-300 group-hover:scale-110 transition-transform"><?php echo e(substr(str_replace(['[', ']'], '', $fav->name), 0, 1)); ?><?php echo e(substr(str_replace(['[', ']'], '', $fav->name), -1)); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <span class="text-[10px] font-bold text-gray-500 dark:text-gray-400 text-center truncate w-full group-hover:text-purple-600 leading-tight"><?php echo e($fav->name); ?></span>
                        </a>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4 mb-8 text-center px-4">
                        <div class="flex-1 min-w-[100px] border-r border-gray-100 dark:border-gray-700 last:border-0 border-opacity-50">
                            <p class="text-3xl font-bold text-gray-800 dark:text-gray-100"><?php echo e(number_format($total_assets)); ?></p>
                            <p class="text-[10px] text-gray-500 font-bold uppercase mt-1 tracking-widest">Assets</p>
                        </div>
                        <div class="flex-1 min-w-[100px] border-r border-gray-100 dark:border-gray-700 last:border-0 border-opacity-50">
                            <p class="text-3xl font-bold text-gray-800 dark:text-gray-100"><?php echo e(number_format($total_documents)); ?></p>
                            <p class="text-[10px] text-gray-500 font-bold uppercase mt-1 tracking-widest">Documents</p>
                        </div>
                        <div class="flex-1 min-w-[100px] border-r border-gray-100 dark:border-gray-700 last:border-0 border-opacity-50">
                            <p class="text-3xl font-bold text-gray-800 dark:text-gray-100"><?php echo e(number_format($total_contacts)); ?></p>
                            <p class="text-[10px] text-gray-500 font-bold uppercase mt-1 tracking-widest">Contacts</p>
                        </div>
                        <div class="flex-1 min-w-[100px] border-r border-gray-100 dark:border-gray-700 last:border-0 border-opacity-50">
                            <p class="text-3xl font-bold text-gray-800 dark:text-gray-100"><?php echo e(number_format($total_organizations)); ?></p>
                            <p class="text-[10px] text-gray-500 font-bold uppercase mt-1 tracking-widest">Orgs</p>
                        </div>
                        <div class="flex-1 min-w-[100px]">
                            <p class="text-3xl font-bold text-gray-800 dark:text-gray-100"><?php echo e(number_format($total_credentials)); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                        ...
                        <a href="<?php echo e(route('organizations.index')); ?>" class="text-xs text-purple-600 hover:underline">Manage All</a>
                    </div>
                    <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody class="divide-y dark:divide-gray-700">
                                <?php $__currentLoopData = $organizations->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $org): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <button 
                                                @click="toggleFavorite(<?php echo e($org->id); ?>, 'App\\Models\\Organization')"
                                                class="mr-4 focus:outline-none group"
                                            >
                                                <svg class="w-5 h-5 transition-colors" :class="isFavorite(<?php echo e($org->id); ?>, 'App\\Models\\Organization') ? 'text-yellow-400 fill-current' : 'text-gray-300 dark:text-gray-600 group-hover:text-yellow-400'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.175 0l-3.976 2.888c-.783.57-1.838-.197-1.539-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                                                </svg>
                                            </button>
                                            <div class="w-8 h-8 mr-3 rounded-lg bg-gray-100 dark:bg-gray-700 p-1 flex items-center justify-center">
                                                <?php if($org->logo): ?>
                                                    <img src="<?php echo e(asset('storage/' . $org->logo)); ?>" class="w-full h-full object-contain">
                                                <?php else: ?>
                                                    <div class="w-full h-full flex items-center justify-center font-bold text-[10px] uppercase text-purple-600">
                                                        <?php echo e(substr($org->name, 0, 2)); ?>
                                            ...
                                            <div>
                                                <p class="font-bold text-sm">
                                                    <?php if($org->parent): ?>
                                                        <span class="text-gray-400 font-normal">[<?php echo e($org->parent->name); ?>]</span>
                                                    <?php endif; ?>
                                                    <?php echo e($org->name); ?>

                                                </p>
                                                <p class="text-xs text-gray-400"><?php echo e($org->slug); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center space-x-3">
                                            <div class="flex flex-col">
                                                <span class="text-xs font-bold text-gray-700 dark:text-gray-200"><?php echo e($org->assets_count); ?></span>
                                                <span class="text-[9px] uppercase text-gray-400">Assets</span>
                                            </div>
                                            <div class="flex flex-col">
                                                <span class="text-xs font-bold text-gray-700 dark:text-gray-200"><?php echo e($org->documents_count); ?></span>
                                                <span class="text-[9px] uppercase text-gray-400">Docs</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <?php if($org->isSuspended()): ?>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="<?php echo e(route('dashboard', $org->slug)); ?>" class="bg-gray-100 dark:bg-gray-700 hover:bg-purple-600 hover:text-white dark:hover:bg-purple-600 text-gray-600 dark:text-gray-200 text-[10px] font-bold py-1.5 px-4 rounded-lg transition-all">View Dashboard</a>
                                    </td>
                                </tr>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <div class="relative pl-6 space-y-8">
                        ...
                        <div class="relative">
                            ...
                            <a href="<?php echo e(route('dashboard', $item->slug)); ?>" class="block p-3 bg-gray-50 dark:bg-gray-900 rounded-lg group cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                <p class="text-xs font-bold text-gray-700 dark:text-gray-200 group-hover:text-purple-500 transition-colors"><?php echo e($item->name); ?></p>
                                <p class="text-[10px] text-gray-500 uppercase font-bold mt-1 text-opacity-70"><?php echo e($item->activity_logs_count); ?> Activities This Week</p>
                                <p class="text-[9px] text-gray-400 mt-1 italic">Last activity <?php echo e($item->activityLogs()->latest()->first()?->created_at->diffForHumans() ?? 'N/A'); ?></p>
                            </a>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <ul class="space-y-4">
                        <?php $__empty_1 = true; $__currentLoopData = $recent_activity->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="flex items-start group cursor-pointer">
                            <a href="<?php echo e(route('dashboard', $activity->organization->slug)); ?>" class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <p class="text-xs font-medium text-gray-600 dark:text-gray-300 group-hover:text-purple-600 transition-colors"><?php echo e($activity->organization->name); ?></p>
                                    <p class="text-[9px] text-gray-400 italic capitalise"><?php echo e($activity->action); ?> • <?php echo e($activity->created_at->diffForHumans()); ?></p>
                                </div>
                            </a>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        const usageChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Assets',
                        data: <?php echo json_encode($chart_data['assets']); ?>,
                        fill: true,
                    ...
                    {
                        label: 'Documents',
                        data: <?php echo json_encode($chart_data['documents']); ?>,
                        fill: true,
                    ...
                    {
                        label: 'Contacts',
                        data: <?php echo json_encode($chart_data['contacts']); ?>,
                        fill: true,
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\orbitdocs\resources\views/global-dashboard.blade.php ENDPATH**/ ?>