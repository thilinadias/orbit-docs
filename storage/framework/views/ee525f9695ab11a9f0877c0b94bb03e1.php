<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data="data()" :class="{ 'dark': dark }">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">

        <title><?php echo e(config('app.name', 'OrbitDocs')); ?></title>
        ...
        <script>
            window.SEARCH_URL = "<?php echo e(route('api.search')); ?>";
        </script>
        ...
        <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
               ...
               <div class="py-4 text-gray-500 dark:text-gray-400">
                    ...
                    <ul class="mt-6">
                        <li class="relative px-6 py-3">
                             <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="<?php echo e(route('dashboard', $currentOrganization->slug ?? 'demo-msp')); ?>">
            ...
            <div class="flex flex-col flex-1 w-full">
                <header class="z-10 py-4 bg-white shadow-sm dark:bg-[#1a1c23] border-b border-gray-100 dark:border-gray-700/50">
                    <div class="flex items-center justify-between h-full px-6 <?php echo e(($hideSidebar ?? false) ? 'w-full' : 'container mx-auto'); ?> text-purple-600 dark:text-purple-300">
                        <!-- Left: Logo & Nav -->
                        <div class="flex items-center justify-start <?php echo e(($hideSidebar ?? false) && !($topNav ?? false) ? 'md:w-1/4' : 'flex-1'); ?>">
                            <!-- Mobile hamburger -->
                            ...
                            <?php if($hideSidebar ?? false): ?>
                                <a class="text-lg font-bold text-gray-800 dark:text-gray-200 flex items-center mr-8" href="<?php echo e(route('root')); ?>">
                                    <?php if($logo = \App\Models\Setting::get('system_logo')): ?>
                                        <img src="<?php echo e(asset('storage/' . $logo)); ?>" alt="System Logo" class="h-8 w-auto mr-3 grayscale brightness-125 hover:grayscale-0 transition-all">
                                    <?php endif; ?>
                                    <span class="hidden lg:inline-block font-extrabold tracking-tighter"><?php echo e(\App\Models\Setting::get('system_name', 'OrbitDocs')); ?></span>
                                </a>
                            <?php endif; ?>
                            ...
                            <?php if(isset($currentOrganization)): ?>
                                <div class="hidden md:flex items-center ml-4 mr-6 px-3 py-1 bg-purple-100 dark:bg-purple-900/50 border border-purple-200 dark:border-purple-700 rounded-md shadow-sm">
                                    ...
                                    <span class="text-xs font-extrabold uppercase tracking-widest text-purple-700 dark:text-purple-300">
                                        <?php echo e($currentOrganization->name); ?> <?php echo e($currentOrganization->isSuspended() ? '(Suspended)' : ''); ?>
                            ...
                            <?php if($topNav ?? false): ?>
                                <nav class="hidden md:flex items-center space-x-6">
                                    <a href="<?php echo e(route('dashboard', $currentOrganization->slug ?? 'demo-msp')); ?>" class="text-xs font-bold uppercase tracking-widest <?php echo e(request()->routeIs('dashboard') ? 'text-purple-600 dark:text-purple-400 border-b-2 border-purple-600' : 'text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'); ?> pb-1 transition-colors">Dashboard</a>
                                    <a href="<?php echo e(route('organizations.index')); ?>" class="text-xs font-bold uppercase tracking-widest <?php echo e(request()->routeIs('organizations.index') ? 'text-purple-600 dark:text-purple-400 border-b-2 border-purple-600' : 'text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'); ?> pb-1 transition-colors">Organizations</a>
                                    
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user.view')): ?>
                                    <a href="<?php echo e(route('users.index')); ?>" class="text-xs font-bold uppercase tracking-widest <?php echo e(request()->routeIs('users.index') ? 'text-purple-600 dark:text-purple-400 border-b-2 border-purple-600' : 'text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'); ?> pb-1 transition-colors">Users</a>
                                    <?php endif; ?>

                                    <a href="<?php echo e(route('root')); ?>" class="text-xs font-bold uppercase tracking-widest <?php echo e(request()->routeIs('root') ? 'text-purple-600 dark:text-purple-400 border-b-2 border-purple-600' : 'text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'); ?> pb-1 transition-colors">Global</a>
                                </nav>
                            <?php endif; ?>
                        </div>
                        ...
                        <!-- Right: Profile & Theme -->
                        <div class="flex items-center justify-end <?php echo e(($hideSidebar ?? false) && !($topNav ?? false) ? 'md:w-1/4' : 'flex-1'); ?>">
                        ...
                        <ul class="flex items-center flex-shrink-0 space-x-6">
                            ...
                            <li class="flex border-l dark:border-gray-700 pl-6 ml-2">
                                <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center text-xs font-bold uppercase tracking-widest text-gray-500 hover:text-purple-600 transition-colors group">
                            ...
                            <li class="relative" x-data="{ isProfileMenuOpen: false }">
                                ...
                                <div x-show="isProfileMenuOpen" 
                                    ...
                                    <ul class="flex flex-col">
                                        <li class="flex">
                                            <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200" href="<?php echo e(route('organizations.index')); ?>">
                                        ...
                                        <?php if(Auth::user()->is_super_admin || Auth::user()->can('user.manage')): ?>
                                        <li class="flex">
                                            <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200" href="<?php echo e(route('roles.index')); ?>">
                                                <svg class="w-4 h-4 mr-3" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <li class="flex">
                                            <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200" href="<?php echo e(route('audit-logs.index')); ?>">
                                                <svg class="w-4 h-4 mr-3" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <?php endif; ?>
                                        <li class="flex">
                                            <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200" href="<?php echo e(route('profile.edit')); ?>">
                                                <svg class="w-4 h-4 mr-3" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
...
<?php /**PATH C:\xampp\htdocs\orbitdocs\resources\views/layouts/app.blade.php ENDPATH**/ ?>